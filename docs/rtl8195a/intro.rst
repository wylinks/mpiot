...
https://github.com/cwyark/micropython/blob/master/rtl8195a/tools/ram_all.tar?raw=true

下載的檔案名稱為ram_all.tar，將此壓縮檔解壓縮後，便可看到一個資料夾build，裡面含有ram_all.bin，將此檔案燒錄至開發板即可使用MicroPython for RTL8195A。各作業系統燒錄方式可參考如下。
